"""
Django settings for directorio_boxeo project.
...
STRIPE_PRICE_BRONZE = os.environ.get("STRIPE_PRICE_BRONCE", "")
STRIPE_PRICE_PLATA = os.environ.get("STRIPE_PRICE_PLATA", "")
STRIPE_PRICE_ORO = os.environ.get("STRIPE_PRICE_ORO", "")
