...
class Command(BaseCommand):
    help = "Genera competidores con nombre y apellidos, algunos con palmarés"
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"✅ Se han creado {total} competidores con nombre, apellido y palmarés aleatorio."))
