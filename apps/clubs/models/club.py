...
class Club(models.Model):
    ...
    # Opening days
    lunes_abierto = models.BooleanField(default=False)
    martes_abierto = models.BooleanField(default=False)
    miercoles_abierto = models.BooleanField(default=False)
    jueves_abierto = models.BooleanField(default=False)
    viernes_abierto = models.BooleanField(default=False)
    sabado_abierto = models.BooleanField(default=False)
    domingo_abierto = models.BooleanField(default=False)
